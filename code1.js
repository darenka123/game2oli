...
{for(var i = 0, len = gdjs.MainGameCode.GDLeftArrowRoundButtonObjects1.length ;i < len;++i) {
    gdjs.MainGameCode.GDLeftArrowRoundButtonObjects1[i].setX(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * (416 / 288));
}
}{for(var i = 0, len = gdjs.MainGameCode.GDRightArrowRoundButtonObjects1.length ;i < len;++i) {
    gdjs.MainGameCode.GDRightArrowRoundButtonObjects1[i].setX(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * (448 / 288));
}
}{for(var i = 0, len = gdjs.MainGameCode.GDTopArrowRoundButtonObjects1.length ;i < len;++i) {
    gdjs.MainGameCode.GDTopArrowRoundButtonObjects1[i].setX(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * (512 / 288));
}
}{for(var i = 0, len = gdjs.MainGameCode.GDFireRoundButtonObjects1.length ;i < len;++i) {
    gdjs.MainGameCode.GDFireRoundButtonObjects1[i].setX(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * (512 / 256));
}
}{for(var i = 0, len = gdjs.MainGameCode.GDBottomArrowRoundButtonObjects1.length ;i < len;++i) {
    gdjs.MainGameCode.GDBottomArrowRoundButtonObjects1[i].setX(gdjs.evtTools.window.getGameResolutionWidth(runtimeScene) * (480 / 288));
}
}}
